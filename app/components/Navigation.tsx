  ...
  return (
    <nav className="hidden md:flex flex-col w-64 fixed left-0 top-0 bottom-0 bg-bg-primary border-r border-border-secondary p-8 z-[100]">
      <div className="flex items-center gap-4 mb-12">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-accent-primary to-accent-pink flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-accent-primary/30">
          F
        </div>
        <span className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-text-dim tracking-tight">
          FitNotes
        </span>
      </div>
